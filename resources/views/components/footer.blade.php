<!-- Footer -->
<footer class="bg-brand-800 text-white" id="contact">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    ...
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-brand-200 text-sm">1800-111-1234 (Toll Free)</span>
                    </li>
                    <li class="flex items-start space-x-3">
                        <svg class="w-5 h-5 text-brand-300 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li class="flex items-start space-x-3">
                        ...
                        <span class="text-brand-200 text-sm">Mon - Sat: 8:00 AM - 8:00 PM</span>
                    </li>
                </ul>
            </div>
        </div>
